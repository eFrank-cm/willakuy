<x-app-layout>
    <x-slot name="header">
        <div class='flex justify-between'>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight flex">
                <img src="{{ asset('images/employee.png')}}" alt="logo" class='h-11 mr-4'>
                <p class="text-2xl inline-block align-text-bottom pt-3.5">{{ __('Employee') }}</p>
            </h2>
        </div>
    </x-slot>
    ...
    <x-content>
        <div class='flex'>
            <form action="{{ route('employee.index') }}" method="GET" class='flex-grow'>
